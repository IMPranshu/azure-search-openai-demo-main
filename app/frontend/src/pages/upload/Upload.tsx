...
export function Component(): JSX.Element {
    ...
    return (
        <>
            <div className="w-full px-4 sm:px-6 lg:px-8 bg-white mx-auto pt-8">
                <h1 className="text-center text-3xl mb-3 font-semibold">Upload Multiple Files</h1>

                {/* Dropzone */}
                <div className="flex pt-5 mx-auto items-center justify-center w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3">
                    <label
